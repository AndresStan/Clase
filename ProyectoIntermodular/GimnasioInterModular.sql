...
CREATE TABLE Pago (
    ...
    CONSTRAINT fk_pago_socio FOREIGN KEY (dni_socio) REFERENCES Socio (dni) ON DELETE cascade on update cascade
);
...
CREATE TABLE Socio_Sala (
    ...
    CONSTRAINT fk_usa_socio FOREIGN KEY (dni_socio) REFERENCES Socio (dni) ON UPDATE CASCADE,
...
-- 3. SOCIO (Insertando ahora con columna ID)
INSERT INTO socio (id, dni, nombre_completo, correo_electronico, fecha_alta, telefono) VALUES
(1, '11111111A', 'Juan Ramirez', 'juan@email.com', '2023-01-15', '600111222'),
(2, '22222222B', 'Maria Torres', 'maria@email.com', '2023-02-20', '600222333'),
(3, '33333333C', 'Antonio Navarro', 'antonio@email.com', '2023-03-10', '600333444'),
(4, '44444444D', 'Carmen Gil', 'carmen@email.com', '2023-04-05', '600444555'),
(5, '55555555E', 'Jose Morales', 'jose@email.com', '2023-05-12', '600555666'),
(6, '66666666F', 'Isabel Ortiz', 'isabel@email.com', '2023-06-18', '600666777'),
(7, '77777777G', 'Francisco Castro', 'fran@email.com', '2023-07-22', '600777888'),
(8, '88888888H', 'Paula Rubio', 'paula@email.com', '2023-08-30', '600888999'),
(9, '99999999I', 'Miguel Serrano', 'miguel@email.com', '2023-09-14', '600999000'),
(10, '00000000J', 'Lucia Molina', 'lucia@email.com', '2023-10-01', '600000111');
